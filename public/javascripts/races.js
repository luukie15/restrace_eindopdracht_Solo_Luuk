    ...
    $.getJSON('/api/races', function (data) {
        ...
        $.each(data.data, function () {
            ...
            if (!userIsAlreadyInRace) {
                ...
                $("#raceListOfUser table tbody").append('<tr><td>' + this.name + '</td><td>' + this.status + '</td><td><button class="btn btn-primary btn-small show_joined_race" rel="' + this._id + '">Show</button></td></tr>');
            }
        });
